...
%>
                       <table width="539" border="2" cellspacing="2" cellpadding="2">
                         ...
                         <tr>
                           <td height="37"><span class="style72">Digital Sign</span></td>
                           <td><span class="style74 style55"><strong>
                             <%out.println(s8);%>
                           </strong></span></td>
                         </tr>
                         <tr>
...
%>
                       ...
                       <p>&nbsp;  </p>
                     <div align="right"><a href="A_AllDocsWithImages.jsp" class="style11">Back</a>                     </div>
