...
.style16 {color: #00CCFF; font-size: 12px; font-weight: bold; }
                ...
                <div class="section_w560">
                    <h2>Welcome To Admin Login</h2>
                     ...
                     <form id="form1" name="form1" method="post" action="AdminAuthentication.jsp">
                       <table width="320" border="0" align="left" cellpadding="2" cellspacing="2">
                         <tr>
                           <td width="162" height="46" align="center">
								 <div align="left" class="style18"><span class="style15">Name (required)</span></div>                             
                          
                          </td>
                           <td width="144"><input id="name" name="userid" class="text" /></td>
                         </tr>
                         <tr>
                           <td height="40" align="center"><div align="left" class="style18"><span class="style15">Password (required)</span></div></td>
