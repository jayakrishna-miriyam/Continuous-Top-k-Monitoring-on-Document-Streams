                  ...
                  <h2><span class="style31 style46 style30 style3">Positive/Negative RF Documents </span></h2>
                     ...
                     <table width="699" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                       <tr>
                         ...
                         <td  width="173" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Positive RF Title </div></td>
                         <td  width="165"  valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Negative RF Title</div></td>
                         <td  width="165"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Found In </div></td>
                       </tr>
                       ...
                       <%
						...
						try 
						{
							...
							if ( rs41.next() )
							{
						   	...
						   	String query1="select distinct(keyword),type from dfound order by id DESC"; 
					   		...
					   		while ( rs1.next() )
					   		{
								...
								type=rs1.getString(2);
									...
									String query2="select distinct(title) from dfound where keyword='"+keyword+"' order by id DESC"; 
