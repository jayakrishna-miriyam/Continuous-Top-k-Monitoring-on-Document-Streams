...
<title>Quantum Detection for Documents..</title>
...
<div id="templatemo_content">
 ...
 <div id="main_column">
                ...
                <div class="section_w560">
                  <h2><span class="style31 style46 style30 style3">Quantum Detection for Documents.</span></h2>
                    
                     <table width="491" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                       <tr>
                         <td  width="81"  valign="middle" height="37" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Si No. </div></td>
                         <td  width="205" valign="middle" height="37" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Keyword</div></td>
                         <td  width="197" valign="middle" height="37" style="color: #2c83b0;">&nbsp;</td>
                       </tr>
                       ...
                       <%
						...
						try 
						{
							...
							ResultSet rs=connection.createStatement().executeQuery("select distinct(keyword) from quantum order by id DESC");
							while(rs.next())
							{
								 keyword=rs.getString(1);
								%>
                       <tr>
                         <td height="52" align="center"  valign="middle"><div align="center" class="style5 style37 style54 style55 style62 style68">
                             <%out.println(i);%>
                         </div></td>
                         <td width="205" rowspan="1" align="center" valign="middle" ><div align="center" class="style5 style20 style37 style54 style55 style62 style68">  
                           
                           <%out.println(keyword);%>
                         </div></td>
                         <td height="52" align="center"  valign="middle"><form method="post" action="A_QuantumDetails.jsp">
                           <input type="hidden" value="<%=keyword%>" name="keyword"/>
                           <input type="submit" name="Submit" value="View All Relevance Details" />
                         </form></td>
                       </tr>
                       <%
						i+=1;}
            ...
            <div id="side_column">
                ...
                <div class="side_column_box">
                    ...
                    <div class="news_section">
                      <ul class="style26">
                        <p><a href="A_Quantum.jsp">Home</a></p>
                        <p>&nbsp;</p>
