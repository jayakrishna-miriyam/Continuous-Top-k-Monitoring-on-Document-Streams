...
%>
					   ...
					   //Finding Total Number of Documents Present Start //
					    String str01 = "select count(*) from documents";
						Statement st01=connection.createStatement();
						ResultSet rs01 = st01.executeQuery(str01);
						
						if(rs01.next())
						{
						
							totaldocs=rs01.getInt(1);
						}
						//Finding Total Number of Documents Present End //
					   ...
					   st3.executeUpdate (query3);
						...
						while(rs.next())
						{
								...
								int totalcnt=0;
								//ArrayList relevance=new ArrayList();
								...
								//Checking in Document Content
								ArrayList al=new ArrayList();
								if (d_Cont1.indexOf(dt1)>=0)
      							{
									al.add(j);//Document ID
								
								
										//Exact Words Count
										java.util.regex.Pattern pattern=java.util.regex.Pattern.compile(dt1+"[^a-z,A-Z]",java.util.regex.Pattern.CASE_INSENSITIVE);
										java.util.regex.Matcher matcher=pattern.matcher(d_Cont1);
										while(matcher.find())
										{
								...
								if(al.size()>0)	
								{
									...
									char ch[]=new char[d_Cont1.length()];
									for(int tt=0;tt<d_Cont1.length();tt++)
									{
										ch[tt]=d_Cont1.charAt(tt);
										if(((tt>0)&&(ch[tt]!=' ')&&(ch[tt-1]==' '))||((ch[0]!=' ')&&(tt==0)))
										{
									...
									st31.executeUpdate (query31);
										...
										{%>
										 <table width="844" border="1" align="center"  cellpadding="0" cellspacing="0">
										   ...
										   <tr>
											 <td  width="66"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style57 style72">Si No. </div></td>
											 <td  width="172" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style57 style72"><strong>Title</strong></div></td>
											 <td  width="160" valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style57 style72">Category </div></td>
											 <td  width="143" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style57 style72">Exact Count </div></td>
											 <td  width="170" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style57 style72">Relevant Count </div></td>
											 <td  width="119" valign="middle" height="34" style="color: #2c83b0;">&nbsp;</td>
										   </tr><%k=2;}%>
										   <tr>
											 ...
											 <td width="172" align="center" valign="middle" ><div class="style66" >
												 <%out.println(s2);%>
											 </div></td>
											 <td align="center"  valign="middle"><div align="center" class="style73">
                                               <%out.println(s1);%>
                                             </div></td>
											 <td height="65" align="center"  valign="middle"><div align="center" class="style73">
												 <%out.println(exactWordCount);%> : <%out.println(totalcnt);%>
											 </div></td>
											 <%
											 ...
											 <td height="65" align="center"  valign="middle"><div align="center" class="style73">
											   <%
													...
													{
														String cutkeyword=dt1.substring(0,i1);
														
														//Matching relevance words
														int relevanceCount=0;
														java.util.regex.Pattern pattern=java.util.regex.Pattern.compile(cutkeyword+"[a-z,A-Z]*",java.util.regex.Pattern.CASE_INSENSITIVE);
														java.util.regex.Matcher matcher=pattern.matcher(d_Cont1);
														while(matcher.find())
														{
															...
															for(int ja=0;ja<=matcher.groupCount();ja++)
															{
																relevanceCount=relevanceCount+=1;
															}
														...
														String ap="=";
														sbf.append(cutkeyword);
														sbf.append(ap);
														sbf.append(relevanceCount);
														al1.add(sbf);
														//relevance.add(al1);
											 ...
											 %>
											       ...
											       <textarea name="textarea" cols="30" rows="6"> <%=al1%></textarea>
										    
										      
											 </div>
										     <div align="center" class="style73"></td>
											 <td height="65" align="center"  valign="middle"><form method="post" action="U_SearchDocDetails2.jsp">
										   ...
										   <% i+=1;
										    String query411 ="insert into quantum(keyword,title,exact,totalwords,relevance,date)values('"+dt1+"','"+s2+"','"+exactWordCount+"','"+totalcnt+"','"+al1+"','"+dt+"')";
									Statement st411=connection.createStatement();
					  				st411.executeUpdate(query411);
									  al1.clear();
									}
										   al.clear();
...
%>
                     ...
                     <p>&nbsp;</p>
                     <p></p>
                     <div align="right"><a href="SearchDocs2.jsp" class="style11">Back</a>                     </div>
