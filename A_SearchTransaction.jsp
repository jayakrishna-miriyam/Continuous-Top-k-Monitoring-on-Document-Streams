...
<title>Users Search Transaction..</title>
...
<div id="templatemo_content">
 ...
 <div id="main_column">
                ...
                <div class="section_w560">
                  <h2><span class="style31 style46 style30 style3"> Users Search Transaction..</span></h2>
                     ...
                     <table width="495" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                       <tr>
                         ...
                         <td  width="120"  valign="middle" height="34" style="color: #2c83b0;">&nbsp;</td>
                       </tr>
                       ...
                       <%
						...
						try 
						{
						   	String query="select distinct(username) from dfound"; 
					...
					%>
                       <tr>
                         <td height="0" align="center"  valign="middle"><div align="center" class="style5 style37 style54 style55 style22 style62">
                             <%out.println(i);%>
                         </div></td>
                         <td width="132" rowspan="1" align="center" valign="middle" ><div class="style5 style37 style54 style55 style22 style62" style="margin:10px 13px 10px 13px;" > <a class="#" id="img1" href="#" >
                             <input  name="image" type="image" src="user_Pic1.jsp?username=<%=s1%>" style="width:90px; height:90px;" />
                         </a> </div></td>
                         <td height="0" align="center"  valign="middle"><div align="center" class="style5 style37 style54 style55 style22 style62">
                           <%out.println(s1);%>
                         </div>
                           <div align="center" class="style5 style20 style37 style54 style55 style22"> <span class="style62"><span class="style61">
                            <a href="A_UserDetails.jsp?username=<%=s1%>">
                         
                           
                         <td valign="middle" height="0" style="color:#000000;"align="center"><form method="post" action="A_SearchTransactionDetails.jsp">
                           <input type="hidden" value="<%=s1%>" name="username"/>
                           <input type="submit" name="Submit" value="View Transaction" />
                         </form></td>
                       </tr>
                       <%
						i+=1;}
            ...
            <div id="side_column">
                ...
                <div class="side_column_box">
                    ...
                    <div class="news_section">
                      <ul class="style26">
                        <p><a href="A_SearchTransaction.jsp">Home</a></p>
                        <p>&nbsp;</p>
