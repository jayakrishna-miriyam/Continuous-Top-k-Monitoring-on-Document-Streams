...
.style77 {color: #009900; font-size: 14px; font-weight: bold; font-family: "Courier New", Courier, monospace; }
.style78 {color: #FF9900}
.style79 {
	color: #FFFF00;
	font-size: 15px;
	font-weight: bold;
...
<div id="templatemo_content">
 ...
 <div id="main_column">
                ...
                <div class="section_w560">
                    <h2><span class="style12"><span class="style1"><span class="style30">Top K Keywords..</span></span></span></h2>
                    
                         <form action="U_TopKKeywords.jsp" method="post">

                       <table align="center" style="margin:0 0 0 30px;">
                         <tr>
                           <td width="139" height="57"><div align="center" class="style3">
                               <div align="right" class="style41">
                                 <div align="center" class="style42">Select Top 'K' </div>
                               </div>
                           </div></td>
...
<div class="section_w560">
                  ...
                  <h2 class="style30"><span class="style30">Found</span> <span class="style30">Top <span class="style78">"<%=request.getParameter("top")%>"</span> Keywords..                  </span></h2>
                  <p>
      	...
      	try 
		{
				   ...
				   int k=1;
		          int i=1;
				  String q2="select * from topkeywords order by count DESC LIMIT 0,"+one+""; 
                  Statement st8=connection.createStatement();
                  ResultSet rs8=st8.executeQuery(q2);
				  while ( rs8.next() )
				  {       	
       		 			
			 			int	Rank=rs8.getInt(3);
						String	keyword=rs8.getString(2);
						/*
						Set h=new HashSet();
						
						 String q21="select * from dsearch where keyword='"+keyword+"'"; 
                 		 Statement st81=connection.createStatement();
                 		 ResultSet rs81=st81.executeQuery(q21);
						 while ( rs81.next() )
						 {
						 	h.add(rs81.getString(2));
						 }
    	*/
       	...
       	%>
				  ...
				  {%>
				      <table width="535" border="1" align="center"  cellpadding="0" cellspacing="0">
                       <tr>
                         <td  width="105"  valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style57 style72">Si No. </div></td>
                         <td  width="267" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style57 style72"><strong>Keyword</strong></div></td>
                         <td  width="155" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style57 style72">Rank </div></td>
                        </tr>
                       <%k=2;}%>
                       <tr>
                         <td height="65" align="center"  valign="middle"><div align="center" class="style77 style80">
                             <%out.println(i);%>
                         </div></td>
                         <td width="267" align="center" valign="middle" ><div class="style66" >
                             <%out.println(keyword);%>
                         </div></td>
                         <td height="65" align="center"  valign="middle"><div align="center" class="style79">
                            <%out.println(Rank);%>
                         </div></td>
                        </tr>
                       <% i+=1;}
