                ...
                <div class="section_w560">
                    <h2><span class="style25">Invalid Login Details, Please Try Again!!</span></h2>
                     ...
                     <form id="form1" name="form1" method="post" action="AdminAuthentication.jsp">
                       <table width="319" border="0" align="left" cellpadding="2" cellspacing="2">
                         <tr>
                           <td width="153" height="46" align="center">
                             <div align="left" class="style18"><span class="style15">Name (required)</span></div>                             
                         </td>
                           <td width="152"><input id="name" name="userid" class="text" /></td>
                         </tr>
                         <tr>
