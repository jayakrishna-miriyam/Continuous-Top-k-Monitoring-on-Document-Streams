...
<div id="templatemo_content">
 ...
 <div id="main_column">
                ...
                <div class="section_w560">
                  <h2><span class="style12"><span class="style1"><span class="style30">User</span> <span class="style23"><span class="style22"><%=request.getParameter("username")%></span><span class="style30">'s</span></span> <span class="style30">Details</span></span><span class="style30">..</span></span></h2>
                    
                     <table width="528" border="1.5" align="center"  cellpadding="0" cellspacing="0"  >
					...
					%>
                       ...
                       <tr>
                         <td  width="120" valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style22 style36" style="margin-left:20px;"><strong>E-Mail</strong></div></td>
                         <td  width="174" valign="middle" height="40" style="color:#000000;"><div align="left" class="style9 style10 style63" style="margin-left:20px;">
                             <%out.println(s1);%>
                         </div></td>
                       </tr>
                       <tr>
                         <td  width="120" valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style22 style36" style="margin-left:20px;"><strong>Mobile</strong></div></td>
                         <td  width="174" valign="middle" height="40"><div align="left" class="style9 style10 style63" style="margin-left:20px;">
                             <%out.println(s2);%>
                         </div></td>
                       </tr>
                       <tr>
                         <td  width="120" align="left" valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style22 style36" style="margin-left:20px;"><strong>Address</strong></div></td>
                         <td  width="174" align="left" valign="middle" height="40"><div align="left" class="style9 style10 style63" style="margin-left:20px;">
                             <%out.println(s3);%>
                         </div></td>
                       </tr>
                       <tr>
                         <td  width="120" align="left" valign="middle" height="40" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style22 style36" style="margin-left:20px;"><strong>Date of Birth</strong></div></td>
                         <td  width="174" align="left" valign="middle" height="40"><div align="left" class="style9 style10 style63" style="margin-left:20px;">
                             <%out.println(s5);%>
                         </div></td>
                       </tr>
                       <tr>
                         <td   width="120" align="left" valign="middle" height="51" style="color: #2c83b0;"><div align="left" class="style15 style7 style4 style3 style22 style36" style="margin-left:20px;"><strong>Status</strong></div                        ></td>
                         <td  width="174" align="left" valign="middle" height="51" style="color: #2c83b0;"><div align="left">
                             <div align="left" class="style9 style10 style63" style="margin-left:20px;">
                               <%out.println(s4);%>
                           </div></td>
                       </tr>
                       <%
					...
					%>
                     ...
                     <p align="justify">&nbsp;</p>
                     <div align="right"><a href="A_AuthorizeUsers.jsp" class="style11">Back</a></div>
