...
<title>Keyword Transaction..</title>
...
.style68 {font-size: 14px; color: #66CCFF; }
-->
</style>
</head>
<body>
...
<div id="templatemo_content">
 ...
 <div id="main_column">
                ...
                <div class="section_w560">
                  <h2 class="style65"><span class="style31 style46 style30 style3 style65">Keyword <span class="style66"><%=request.getParameter("keyword")%></span>'s Transaction..</span></h2>
                  <table width="495" border="1" align="center"  cellpadding="0" cellspacing="0"  ">
                       <tr>
                         ...
                         <td  width="210" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">User Name </div></td>
                         <td  width="182" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style56 style57">Searched On </div></td>
                       </tr>
                       ...
                       <%
						...
						try 
						{
							String keyword=request.getParameter("keyword");
						   	String query="select username,dt from dsearch where keyword='"+keyword+"'"; 
					...
					%>
                       <tr>
                         <td height="50" align="center"  valign="middle"><div align="center" class="style5 style37 style54 style55 style22"><span class="style61">
                             <%out.println(i);%>
                         </span></div></td>
                         <td width="210" rowspan="1" align="center" valign="middle" ><div align="center" class="style5 style20 style37 style54 style55 style22"> <span class="style61"> 
                           <%out.println(s1);%>
                         </span></div></td>
                         <td height="50" align="center"  valign="middle"><div align="center" class="style5 style20 style37 style54 style55 style22"> <span class="style61">
                             <%out.println(s2);%>
                         </a></span></div></td>
                       </tr>
                       <%
					...
					%>
                     ...
                     <p align="justify">&nbsp;</p>
                     <div align="right"><a href="A_AllPNFeedback.jsp" class="style11">Back</a>                     </div>
