            ...
            <div id="side_column">
                ...
                <div class="side_column_box">
                    ...
                    <div class="news_section">
                      <ul class="style26">
                        <p><a href="AdminMain.jsp">Home</a></p>
                        <p>&nbsp;</p>
                        <p><a href="A_AuthorizeUsers.jsp">Authorize Users</a></p>
                        <p>&nbsp;</p>
                        <p><a href="A_AddDoc.jsp"> Add Documents </a></p>
                        <p>&nbsp;</p>
                        <p><a href="A_AllDocsWithImages.jsp">All Documents </a></p>
                        <p>&nbsp;</p>
                        <p><a href="A_RelevantResults.jsp">Chart Results</a></p>
                        <p>&nbsp;</p>
                        <p><a href="A_SearchTransaction.jsp">Search Transaction </a></p>
                        <p>&nbsp;</p>
                        <p><a href="A_AllRelevance.jsp">Relevance Documents Ratio</a></p>
                        <p>&nbsp;</p>
                        
                        <p><a href="A_AllPNFeedback.jsp">Positive RF/Negative RF Documents </a></p>
                        <p>&nbsp;</p>
