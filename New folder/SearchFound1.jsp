...
try 
{
	...
	String dt = strDate + "   " + strTime;
		...
		else
		{
				...
				String s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,d_Cont;
				int i=1,j=0,k=1;
				int relevant=0,totaldocs=0,irrelevant=0;
...
%>
					  ...
					  /* Statement st3 = connection.createStatement();
					   ...
					   st3.executeUpdate (query3);*/
						...
						String str = "select * from documents order by count DESC";// where dtitle LIKE '"+dt1+"'";
						...
						while(rs.next())
						{
								...
								//Splitting Word into Characters to Search
									int len=dt1.length();
									for(int i1=2;i1<=len;i1++)
									{
										String cutkeyword=dt1.substring(0,i1);
											...
											//Matching relevance words
												...
												out.print("cutkeyword is= " +cutkeyword+ "<br/>  Found Totally="+to+"<br/><br/>");
					 ...
					 <table width="723" border="1" align="center"  cellpadding="0" cellspacing="0">
                       ...
                       <tr>
                         ...
                         <td  width="177" valign="middle" style="color: #2c83b0;"><div align="center" class="style5 style57 style72">Category </div></td>
                         <td  width="177" valign="middle" height="34" style="color: #2c83b0;"><div align="center" class="style5 style57 style72">Exact Count  </div></td>
                       ...
                       <tr>
                         ...
                         <td height="65" align="center"  valign="middle"><form method="post" action="U_SearchDocDetails1.jsp">
                       ...
                       <% i+=1;
      								 ...
      								 irrelevant=totaldocs-relevant;} %></table>
					 <%
					   ...
					   <p align="center" class="style80"><span class="style84">Negative <span class="style88">Relevance</span> Feedback Found is -></span>
			             <span class="style87">
			             <%out.print(irrelevant);%>  :   <%out.print(totaldocs);%>
                         </span></p>
					   <%	   
...
%>
                     ...
                     <p>&nbsp;</p>
                     <p></p>
                     <div align="right"><a href="SearchDocs1.jsp" class="style11">Back</a>                     </div>
